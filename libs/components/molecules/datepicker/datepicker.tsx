...
import { BACKSPACE_KEY } from '../otp-inputs/constants';
import CalendarIcon from '@libs/assets/images/svgs/calendar.svg';
...
import { checkDate, maskDate } from '@libs/utils/string.utils';
...
const DatePicker = ({ name, value, onChange }: DatePickerProps) => {
  const calendarRef = useRef<DynamicType>(null);
  const calendarIconRef = useRef<DynamicType>(null);
  const datePickerModalRef = useRef<DynamicType>(null);
